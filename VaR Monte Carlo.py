# -*- coding: utf-8 -*-
"""
Created on Sun Sep 26 09:36:25 2021
...
for ticker in range(thelen):
   prices = web.DataReader(tickers[ticker], start='2018-06-20', end = '2020-09-20', data_source='yahoo')
...
# Weights are to optimise SHarpe ratio
#Annualized Return
...
#use weights to calculate portfolio return
#VaR Calculation
ticker_rx2 = []
...
#Multiply Holding Period return by weights.
...
#Print upper and lower lomit and Portfolio value
